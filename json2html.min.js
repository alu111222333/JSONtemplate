...
Array.prototype.slice.call(a.getElementsByTagName("script"));for(var b=0;b<a.length;b++){if(""!=a[b].src){var c=document.getElementsByTagName("head")[0],h=r(a[b].src),d=e(".","_",e(":","_",e("/","_",h)));if(!document.getElementById(d)){var f=document.createElement("script");f.src=h;f.id=d;c.appendChild(f)}}else eval(a[b].innerHTML);a[b].parentElement.removeChild(a[b])}}function e(a,b,c){return void 0===c?c:String.prototype.replaceAll?c.replaceAll(a,b):c.split(a).join(b)}function r(a){return void 0===
a||null===a||1>a.length?"":String.prototype.trim?a.trim():a.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")}function y(a){G&&console.log("Json2Html: "+a)}function J(a,b){var c="undefined"==typeof b?1:b,h="";c||(c=0);for(var d="",f=0;f<c+1;f++)d+="    ";if("object"==typeof a)for(var e in a)f=a[e],"object"==typeof f?(h+=d+"'"+e+"' :\n",h+=J(f,c+1)):h+=d+"'"+e+"' => \""+f+'"\n';else h="===>"+a+"<===("+typeof a+")";return h}function N(a,b,c,h){h="undefined"==typeof h?500:h;G&&y("Network: "+b+"\n"+J(c));
a(JSON.parse('{"error":{"state":true,"title":"Network error","message":"'+e("'","",e('"',"",b))+'","code":'+h+"}}"))}function P(a,b,c,h,d){var f={mode:"same-origin",cache:"no-cache",credentials:"same-origin",redirect:"follow"},e="JSON"==r(b).toUpperCase();"POST"==r(a).toUpperCase()?(f.method="POST",f.body=JSON.stringify(h),f.headers={"Content-Type":"application/json",Accept:e?"application/json":"text/html"}):(f.method="GET",f.headers={Accept:e?"application/json":"text/html"});fetch(c,f).then(function(a){if(!a.ok)throw Error(a.statusText);
return e?a.json():a.text()}).then(function(a){d(a)})["catch"](function(a){e?N(d,a.message,a):(G&&y(textStatus+"\n"+J(errorThrown)),alert('json2html: "'+c+'" '+a.message))})}function Q(a,b,c,h,d){var f=new XMLHttpRequest;f.withCredentials=!0;var e="JSON"==r(b).toUpperCase();a="POST"==r(a).toUpperCase();f.onload=function(a){if(4==f.readyState)if(200==f.status)if(a=f.responseText,e)try{d(JSON.parse(a))}catch(F){N(d,F.name,F,f.status)}else d(a);else N(d,"Wrong status "+f.status,{error:"XMLHttpRequest",
status:f.status},f.status)};f.onerror=function(a){N(d,f.statusText,a,f.status)};f.open(a?"POST":"GET",c,!0);a?(f.setRequestHeader("Content-Type","application/json"),f.setRequestHeader("Accept",e?"application/json":"text/html"),f.send(JSON.stringify(h))):(f.setRequestHeader("Accept",e?"application/json":"text/html"),f.send())}function aa(a,b,c){void 0===b?y("Undefined URL in templates array"):(H++,"fetch"in window?P("get","text",b,null,function(h){U(h,a,c,b)}):Q("get","text",b,null,function(h){U(h,
a,c,b)}))}function U(a,b,c,h){h=h.substring(h.lastIndexOf("/")+1);h=r(h.substring(0,h.lastIndexOf(".")));if(a.match(/^\s*?NextTemplateName:\s*?\S{1,100}\s*?$/m)){y("File with templates detected: "+h);a=a.split("NextTemplateName:");var d;for(d=0;d<a.length;d++){var f=a[d].indexOf("\n"),e;if(0<d){if(0>f||100<f){y("Strange template loaded from file "+h+'. All templates should be starter with line "NextTemplateName: name_of_template"');y(a[d]);continue}e=r(a[d].substring(0,f));f=r(a[d].substring(f+1))}else{f=
r(a[d]);if(0==f.length){y('thete is nothing in first "'+h+'" of the content '+d);continue}e=h}0==f.length?y("thete is nothing in one of the content "+d):(0==e.length&&(y("thete is no title in one of the templates "+d),e=h),b[e]=f,y("Loaded template "+e+" from file "+h))}}else b[h]=a,y("Loaded file "+h);H--;0==H&&c()}function V(a){var b={};a=a.querySelectorAll("input, select, textarea");for(var c=0;c<a.length;++c){var h=a[c],d=h.name;if(d){var f=h.value;"INPUT"==h.tagName.toUpperCase()&&"CHECKBOX"==
h.type.toUpperCase()&&(h.checked||(f+="__false"));var m=b,k=d;if(/\[.*?\]/.test(k)){var n=k.split("[")[0],d=k.match(/\[.*?\]/g),h=d.length,k=-1!=k.indexOf("[]");void 0===m[n]&&(m[n]=1==h&&k?[]:{});n=m[n];for(m=0;m<h;m++){var g=e("[","",e("]","",d[m]));m==h-1?""==g?Array.isArray(n)&&n.push(f):n[g]=f:(void 0===n[g]&&(n[g]=m==h-2&&k?[]:{}),n=n[g])}}else void 0===m[k]&&(m[k]=f)}}return b}function W(){if(!(1>H))return!1;var a=K,b;for(b in a)a[b]=e(z[0].charAt(0)+" "+z[0].charAt(1),z[0],a[b]),a[b]=e(A[0].charAt(0)+
" "+A[0].charAt(1),A[0],a[b]),a[b]=e(B[0].charAt(0)+" "+B[0].charAt(1),B[0],a[b]),a[b]=e(z[1].charAt(0)+" "+z[1].charAt(1),z[1],a[b]),a[b]=e(A[1].charAt(0)+" "+A[1].charAt(1),A[1],a[b]),a[b]=e(B[1].charAt(0)+" "+B[1].charAt(1),B[1],a[b]),a[b]=e(z[0]+"  ",z[0],a[b]),a[b]=e(z[0]+" ",z[0],a[b]),a[b]=e(A[0]+"  ",A[0],a[b]),a[b]=e(A[0]+" ",A[0],a[b]),a[b]=e(B[0]+"  ",B[0],a[b]),a[b]=e(B[0]+" ",B[0],a[b]),a[b]=e("  "+z[1],z[1],a[b]),a[b]=e(" "+z[1],z[1],a[b]),a[b]=e("  "+A[1],A[1],a[b]),a[b]=e(" "+A[1],
A[1],a[b]),a[b]=e("  "+B[1],B[1],a[b]),a[b]=e(" "+B[1],B[1],a[b]),a[b]=e("` then `","`then`",a[b]),a[b]=e("` then","`then",a[b]),a[b]=e("then `","then`",a[b]),a[b]=e("` else `","`else`",a[b]),a[b]=e("` else","`else",a[b]),a[b]=e("else `","else`",a[b]),a[b]=e("if = `","if=`",a[b]),a[b]=e("if= `","if=`",a[b]),a[b]=e("if =`","if=`",a[b]);R(K);X()}function Z(a){var b=ba,c,h,d,f;c=a.length&3;h=a.length-c;d=b;for(b=0;b<h;)f=a.charCodeAt(b)&255|(a.charCodeAt(++b)&255)<<8|(a.charCodeAt(++b)&255)<<16|(a.charCodeAt(++b)&
255)<<24,++b,f=3432918353*(f&65535)+((3432918353*(f>>>16)&65535)<<16)&4294967295,f=f<<15|f>>>17,f=461845907*(f&65535)+((461845907*(f>>>16)&65535)<<16)&4294967295,d^=f,d=d<<13|d>>>19,d=5*(d&65535)+((5*(d>>>16)&65535)<<16)&4294967295,d=(d&65535)+27492+(((d>>>16)+58964&65535)<<16);f=0;switch(c){case 3:f^=(a.charCodeAt(b+2)&255)<<16;case 2:f^=(a.charCodeAt(b+1)&255)<<8;case 1:f^=a.charCodeAt(b)&255,f=3432918353*(f&65535)+((3432918353*(f>>>16)&65535)<<16)&4294967295,f=f<<15|f>>>17,d^=461845907*(f&65535)+
((461845907*(f>>>16)&65535)<<16)&4294967295}d^=a.length;d^=d>>>16;d=2246822507*(d&65535)+((2246822507*(d>>>16)&65535)<<16)&4294967295;d^=d>>>13;d=3266489909*(d&65535)+((3266489909*(d>>>16)&65535)<<16)&4294967295;return(d^d>>>16)>>>0}function R(a,b){var e="undefined"==typeof b?[]:b;if(void 0===a)return"";if(null===a||Number.isInteger(a)||void 0===D||null===D||"object"!=typeof D)return a;if("string"===typeof a)return S(a);M--;if(0>M)return M++,alert("Stackoverflow protection triggered"),M=10,a;var h=
!1;Array.isArray(e)&&0<e.length&&(h=!0);for(var d in a)if(void 0!==a[d]&&null!==a[d]&&!Number.isInteger(a[d]))if(Array.isArray(a[d])||"object"==typeof a[d])R(a[d],e);else if("string"===typeof a[d]||a[d]instanceof String)h?c(e,d,!0)&&(a[d]=S(a[d])):a[d]=S(a[d]);M++;return a}function S(a){if(void 0===a)return"";if(void 0===D||null===D||"object"!=typeof D)return a;var b,c;if(0>a.length-7)return a;for(var e,d=a.indexOf("@str."),f=300;-1!=d;){f--;if(0>f){alert("Loop protection: JS template library");break}c=
d+5;a:{b=c;e=a;var m,k,n=-1,g=e.length;for(m=0;41>m;m++){n=b+m;if(n>=g){b=g;break a}k=e.charCodeAt(n);if(!(48<=k&&57>=k||65<=k&&90>=k||97<=k&&122>=k||95==k)){b=n;break a}}b=n}e=b-c;2<e||40>e?(c=a.substr(c,e),void 0!==D[c]?(a=a.replace("@str."+c,D[c]),d=a.indexOf("@str.",d+1)):(console.log('No translation for key: "'+c+'"'),d=a.indexOf("@str.",b))):d=a.indexOf("@str.",b)}return a}var G=!1,z=["[*","*]"],A=["[!","!]"],B=["{{","}}"],I="",T=Math.floor(999*Math.random()+1),L=0,H=0;if(void 0!==jQuery)try{jQuery.fn.serializeHtmlForm=
function(){return V(this[0])},jQuery.fn.injectJSON=function(a,b){var c=x(a,b);this.each(function(){jQuery(this).html(c);n(jQuery(this)[0])});return this}}catch(a){}var X=0,K={},ba=Math.round(1E4*Math.random()+1E4),M=10,D=null;return{render:x,inject2DOM:function(a,b,c){var e=null;try{e=document.querySelectorAll(c)}catch(d){}if(void 0===e||null==e)return[];a=x(a,b);for(b=0;b<e.length;++b)c=e[b],"innerHTML"in c&&(c.innerHTML=a,n(c));return e},getJSON:function(a,b){"fetch"in window?P("get","json",a,null,
b):Q("get","json",a,null,b)},postJSON:function(a,b,c){"fetch"in window?P("post","json",a,b,c):Q("post","json",a,b,c)},loadTemplatesArray:function(a,b,c){c="undefined"==typeof c?!0:c;1>H||alert("Critical error.\nTrying to load templates before previous templates request is completed");c&&(K={});X=b;H++;for(b=0;b<a.length;b++)aa(K,a[b],W);H--;W()},setTranslationArray:function(a){void 0===a?console.log("Translation array is undefined"):(D=a,0==Object.keys(D).length&&(D=null))},translate:R,executeJS:n,
printObject:J,setDebug:function(a){G=a},serializeHtmlForm:function(a){a=document.querySelector(a);return void 0===a||null==a?{}:V(a)}}}(),jth=json2html;
